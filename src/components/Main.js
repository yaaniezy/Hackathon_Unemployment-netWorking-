  ...
  return (
    <Container>
      <ShareBox>
        ...
        <div>
          <button>
            <mg src="/images/photo-icon.svg" alt="" />
            <span>Photo</span>
          </button>
          <button>
      ...
      <div>
        <Article>
          ...
          <SocialCounts>
            <li>
              <button>
                <img src="https://static-expl.licdn.com/sc/h/d310t2g24pvdy4pt1jkedo4yb" />
                <img
          ...
          <SocialActions>
            <button>
              <img href="https://img.icons8.com/ios-filled/50/000000/webcam-man.png%22/%3E" />
              <span>like</span>
            </button>
            <button>
